...
class GearsDetailedExtensionView(context: Ki2ExtensionContext,) : Ki2ExtensionView(context) {
    ...
    override fun createView(layoutInflater: LayoutInflater, viewConfig: ViewConfig): View {
        val inflatedView = layoutInflater.inflate(R.layout.view_karoo_gears_detailed, null)
        ...
        textViewWaitingForData =
            inflatedView.findViewById(R.id.textview_karoo_gears_detailed_waiting_for_data)
        batteryView = inflatedView.findViewById(R.id.batteryview_karoo_gears_detailed)
        textViewGears = inflatedView.findViewById(R.id.textview_karoo_gears_detailed)
        textViewBattery = inflatedView.findViewById(R.id.textview_karoo_gears_detailed_battery)
        gearsView = inflatedView.findViewById(R.id.gearsview_karoo_gears_detailed)
        ...
        if (karooTheme == KarooTheme.WHITE) {
            ...
            textViewBattery?.setTextColor(context.getColor(R.color.hh_black))
            ...
            textViewBattery?.setTextColor(context.getColor(R.color.white))
    ...
    private fun updateView() {
        ...
        textViewGears.text = context.getString(
                R.string.text_param_gearing_detailed,
                shiftingGearingHelper.frontGear,
